            ...
            @foreach($surcharges as $surcharge)
                <tr>
                    <td class="px-6 py-4 whitespace-no-wrap">
                        <div class="text-sm leading-5 text-gray-900 dark:text-gray-400">{{ $surcharge->name }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-no-wrap">
                        <div class="text-sm leading-5 text-gray-900 dark:text-gray-400">{{ $surcharge->price }}<div>
                    </td>
                    <td class="px-6 py-4 whitespace-no-wrap">
                        <div class="text-sm leading-5 text-gray-900 dark:text-gray-400">{{ $surcharge->getType() }}<div>
                    </td>
                    <td class="px-6 py-4 whitespace-no-wrap">
                        <div class="text-sm leading-5 text-gray-900 dark:text-gray-400">@if($surcharge->editable) {{ __('Yes') }} @else {{ __('No') }} @endif<div>
                    </td>
